...
export interface LlmPresetRowProps {
  preset: LlmPreset
      ...
      <div className="flex items-center gap-3 px-3 py-2.5">
        ...
        <button
          ...
          className={`relative inline-flex h-5 w-9 shrink-0 items-center rounded-full border transition-colors ${
            toggleDisabled
              ? "cursor-not-allowed border-muted-foreground/20 bg-muted/40 opacity-50"
              : isActive
          ...
          title={
            toggleDisabled
              ? t("settings.sections.agentLlm.unsupportedPreset")
              : isActive
                ? t("settings.sections.llm.toggleOff")
                : t("settings.sections.llm.toggleOn")
          }
